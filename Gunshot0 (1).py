...
path='C://Users//PNW_checkout//Downloads//Deeplearning//Gunshot//RasberryPi//'
x=['gun.mp3','gun2.mp3','gun-gunshot-01.mp3','gun-gunshot-02.mp3','machine-gun-01.mp3','gun-shot.mp3','sniper.mp3']
for i in x:
    microphone_data=path+i


# In[68]:


labels = np.load("C://Users//PNW_checkout//Downloads//Deeplearning//Gunshot//RasberryPi//augmented_labels.npy")
...
def create_gunshot_wav_file(microphone_data, index, timestamp):
    librosa.output.write_wav("C://Users//PNW_checkout//Downloads//Deeplearning//Gunshot//RasberryPi//"
                            + str(index) + " ("
...
interpreter_1 = tf.lite.Interpreter(model_path = "C://Users//PNW_checkout//Downloads//Deeplearning//Gunshot//RasberryPi//1D.tflite")
...
interpreter_2 = tf.lite.Interpreter(model_path = "C://Users//PNW_checkout//Downloads//Deeplearning//Gunshot//RasberryPi//128_x_64_2D.tflite")
...
interpreter_3 = tf.lite.Interpreter(model_path = "C://Users//PNW_checkout//Downloads//Deeplearning//Gunshot//RasberryPi//128_x_128_2D.tflite")
